...
function WorkspaceRightRail() {
  ...
  const [updates] = createResource('workspace-package-updates', () => studioApi.catalog('updates'));
  const updateError = () => updates.error instanceof Error ? updates.error.message : typeof updates.error === 'string' ? updates.error : 'OMP could not check the configured marketplaces.';
